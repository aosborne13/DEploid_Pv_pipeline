...
# Get the GT, REF.AD, and ALT.AD file paths from command line arguments
args <- commandArgs(trailingOnly = TRUE)
if (length(args) < 3) {
  stop("Usage: <GT file> <REF.AD file> <ALT.AD file>")
}
...
# Call the AF.workflow function with the provided files
AF.workflow(GT.file, REF.AD.file, ALT.AD.file)
